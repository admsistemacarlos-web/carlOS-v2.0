        ...
        <div className="flex flex-col md:flex-row justify-between gap-4">
          <div className="relative flex-1 max-w-md">
            ...
            <input 
              ...
              className="w-full h-12 bg-card border border-border rounded-xl pl-10 pr-4 text-sm text-foreground focus:border-primary outline-none transition-all"
            />
          </div>
          ...
          <div className="flex gap-3">
             <button 
               ...
               className="h-12 px-6 border border-border hover:border-muted-foreground text-foreground font-bold uppercase tracking-wider text-xs rounded-xl transition-all flex items-center gap-2"
             >
               <FileText size={16} /> Templates
             </button>
             <button 
               onClick={() => navigate('/professional/quotes/new')}
               className="h-12 px-6 bg-primary hover:bg-primary/90 text-background font-bold uppercase tracking-wider text-xs rounded-xl shadow-[0_0_15px_rgba(224,155,107,0.2)] transition-all flex items-center gap-2"
             >
          ...
          <div className="grid grid-cols-1 gap-4">
            {filteredQuotes?.map((quote) => (
              <div 
                ...
                className="bg-card border border-border rounded-2xl p-5 flex flex-col md:flex-row items-start md:items-center justify-between gap-4 hover:border-primary/50 transition-all cursor-pointer group relative overflow-hidden"
              >
                {/* Status Stripe */}
                ...
                <div className="flex items-center gap-6 pl-3 md:pl-0 w-full md:w-auto justify-between md:justify-end">
                    <div className="text-right">
                        <p className="text-[10px] text-muted-foreground uppercase font-bold">Total Mensal</p>
                    ...
                    <div className="text-right border-l border-border pl-4">
                        <p className="text-[10px] text-muted-foreground uppercase font-bold">Setup</p>
                    ...
                    <div className="flex items-center gap-2 pl-2" onClick={e => e.stopPropagation()}>
                        ...
                        <button 
                            ...
                            className="p-2 hover:bg-border text-muted-foreground hover:text-white rounded-lg transition-colors border border-transparent hover:border-secondary"
                        >
                            <Eye size={18} />
                        </button>
                        ...
                        <button 
                            ...
                            className="p-2 hover:bg-border text-muted-foreground hover:text-primary rounded-lg transition-colors border border-transparent hover:border-secondary"
                        >
                            <Pencil size={18} />
                        </button>
